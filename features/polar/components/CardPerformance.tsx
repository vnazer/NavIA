    ...
    <View className="gap-3 rounded-2xl bg-white p-5 shadow-sm">
      <View className="flex-row items-center justify-between">
        <View className="flex-row items-center gap-2">
          ...
          <Text className="text-sm font-semibold uppercase tracking-wide text-slate-700">
      ...
      {optimos && (
        <View className="gap-3">
          {/* Ceñida */}
          <View className="flex-row items-center justify-between rounded-xl bg-mar-50 p-3">
            <View>
            ...
            <View className="items-end">
              ...
              <Text className="text-xs text-slate-600">kt esperados</Text>
          ...
          <Link href="/polar" asChild>
            <Pressable className="flex-row items-center justify-center gap-2 rounded-xl bg-slate-100 p-3">
